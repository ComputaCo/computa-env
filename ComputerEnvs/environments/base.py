...
class BaseComputerEnv:
        ...
        return spaces.Dict(
            {
                ...
                in [PeripheralType.OUTPUT, PeripheralType.BOTH]
            }
        )
    ...
    def _get_observation(self):
        return {
            modality.name: modality.get_observation()
            for modality in self.modalities
    ...
    def _apply_action(self, action):
        for modality in self.modalities:
            ...
            if modality.name in action and modality.peripheral_type in [
                PeripheralType.INPUT,
                PeripheralType.BOTH,
            ]:
